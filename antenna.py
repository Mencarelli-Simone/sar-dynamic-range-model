...
class Antenna:
    ...
    def __init__(self):
        ...
        self.L = 6  # m
        self.lamda = 3E8 / 10E9
        self.cubic = False  # interpolation method for antenna pattern, true cubic, false linear
        ...
        pattern_folder_path = './Antenna_Pattern'
    ...
    def get_normalized_gain_at_lcs_point(self, position: np.ndarray) -> complex:
        """
